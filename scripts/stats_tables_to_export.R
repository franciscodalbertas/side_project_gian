...
write.csv(tot_restor_country,"output_tables/total_restorable_area_per_country.csv",row.names = F)
...
top30_high_bio_combined_30countries_ordered <- top30_high_bio_combined_30countries %>%
  group_by(country_name) %>%
  mutate(
